...
one_antisites = [5.97305972, 4.6262301,3.637150,2.89114] # k of the systems with 0.25% Frenkel defects 
one_error = [0.3043,0.19079,0.0692953,0.071469]
five_antisites = [4.16446, 3.48751,2.886,2.45038] # k of the systems with 1% Frenkel defects
five_error = [0.1017,0.08765,0.048524,0.030175]
two_antisites = [5.168742,4.0836516,3.25551,2.72] #k of the systems with 0.5% Frenkel defects
two_error = [0.1875,0.06989,0.07369,0.04068]
...
plt.legend()
plt.savefig('Frenkel_analytical_2.png', bbox_inches = 'tight', dpi=300)
plt.show()
